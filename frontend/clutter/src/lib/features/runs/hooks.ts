...
export const useCreatePlaybookUploadUrl = (token?: string | null) => {
  return useMutation({
    ...
    mutationFn: (input: CreatePlaybookUploadUrlInput) =>
      runsApi.createPlaybookUploadUrl(token as string, input),
  });
};
...
export const useUploadPlaybookFileToS3 = () => {
  return useMutation({
    ...
    mutationFn: (input: UploadPlaybookFileToS3Input) =>
      runsApi.uploadPlaybookFileToS3(input),
  });
};
...
export const useSubmitAnsibleJob = (token?: string | null) => {
  return useMutation({
    ...
    mutationFn: (input: SubmitAnsibleJobInput) =>
      runsApi.submitAnsibleJob(token as string, input),
  });
};
